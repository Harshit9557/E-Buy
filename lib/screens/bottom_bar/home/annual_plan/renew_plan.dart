...
class RenewAnnualPlanScreen extends StatefulWidget {
  const RenewAnnualPlanScreen({Key? key}) : super(key: key);
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "For Listing a Business/Servive and Renewal",
                              style: TextStyle(
                                fontWeight: FontWeight.w400,
                                fontSize: 11,
                                color: kPlansDescriptionTextColor,
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Flexible(
                                    child: Text(
                                      "Get 100% cashback in the form of e-buy reward points in your e-buy wallet. ",
                                      style: TextStyle(
                                        fontWeight: FontWeight.w400,
                                        fontSize: 16,
                                        color: Colors.black,
